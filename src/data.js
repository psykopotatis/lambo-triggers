const triggerData = [
    {
        ...
        "date": "2025-09-30",
        "originalDate": "Q3/Q4",
        "triggerDescription": "FDA:s beslut om Premarket Approval (PMA) för Implanticas refluximplantat RefluxStop i USA. Bolaget har skickat in sista modulen till FDA och väntar besked under hösten 2025:contentReference[oaicite:0]{index=0}. Ett godkännande skulle ge tillträde till den stora USA-marknaden för RefluxStop.",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 30
    },
    {
        "stockName": "Xspray",
        "trigger": "Besked från FDA",
        ...
        "triggerDescription": "FDA:s beslut (PDUFA-datum 7 okt 2025) om Xsprays ansökan för Dasynoc – en ny formulering av cancerläkemedlet dasatinib:contentReference[oaicite:1]{index=1}. Ett godkännande innebär bolagets första produktlansering i USA och bekräftelse på deras teknik efter en tidigare FDA-nekande (CRL).",
        "triggerImpact": "hög",
    ...
    },
    {
        ...
        "date": "2025-09-30",
        "originalDate": "Q3/Q4",
        "triggerDescription": "Resultat från Curasights pågående studier av uPAR-baserade cancerdiagnostik- och behandlingsplattformen. Dels topline-data från fas II-studien av bilddiagnostikspårämnet uTRACE (t.ex. i prostatacancer) under H2 2025, dels preliminära effektdata från fas I-studien av det terapeutiska radionuklidläkemedlet uTREAT (glioblastom) mot slutet av 2025:contentReference[oaicite:3]{index=3}. Positiva data skulle bekräfta plattformens kliniska potential och bana väg för partnerskap (Curium är redan partner för uTRACE:contentReference[oaicite:4]{index=4}).",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 70
    },
    {
        ...
        "date": "2025-12-31",
        "originalDate": "Q4",
        "triggerDescription": "Topplinedata från Guard Therapeutics fas IIb-studie POINTER, som utvärderar läkemedlet RMC-035 (ROSgard) för njurskydd hos patienter som genomgår hjärtkirurgi. Studien är fullrekryterad (170 patienter) och tre månaders uppföljning innebär att resultat väntas mot slutet av 2025:contentReference[oaicite:5]{index=5}. Positivt utfall (skydd av njurfunktion) skulle vara ett stort genombrott och öka sannolikheten för en partner eller fas III-start, givet att nuvarande börsvärde är relativt lågt jämfört med marknadspotentialen.",
        "triggerImpact": "jättehög",
        "triggerImpactPercentage": 100
    },
    {
        "stockName": "Lipigon",
        ...
        "date": "2025-12-31",
        "originalDate": "Q4",
        "triggerDescription": "Första resultat från Lipigons fas II-studie av Lipisense, en antisense-behandling som siktar på ANGPTL4 för att sänka triglyceridnivåer. Studien förväntas inkludera sista patienten i H1 2025 och presentera initiala data under H2 2025:contentReference[oaicite:6]{index=6}. Om data visar tydlig måluppfyllnad (t.ex. sänkta triglycerider) kan intresset från större bolag öka kraftigt, då Lipisense adresserar kardiometabola behov. Givet Lipigons mycket låga börsvärde skulle positiva resultat kunna ge en kraftig kursuppgång.",
        "triggerImpact": "jättehög",
        "triggerImpactPercentage": 100
    },
    {
        ...
        "date": "2025-12-31",
        "originalDate": "H2",
        "triggerDescription": "Två viktiga studieresultat väntas under H2 2025 för Hansa. Dels utfallet i den pivotala fas III-studien ConfIdeS som utvärderar imlifidase (Idefirix) som desensibiliseringsbehandling vid njurtransplantation (avgörande för ett FDA-godkännande i USA):contentReference[oaicite:7]{index=7}. Dels resultaten från en fas III-studie i anti-GBM-syndrom (en sällsynt autoimmun njursjukdom):contentReference[oaicite:8]{index=8}. Positiva resultat skulle kraftigt stärka Imlifidase användningsområde och försäljningspotential, samt bana väg för marknadsgodkännande i USA. Trots Hansas medelstora börsvärde väntas en tydlig kursreaktion vid framgång, om än inte lika dramatisk som för mindre bolag.",
        "triggerImpact": "hög",
    ...
    },
    {
        ...
        "triggerDescription": "Resultat från Synacts pågående fas IIb-studie (ADVANCE) med resomelagon (AP1189) i nyligen diagnostiserad svår reumatoid artrit. Bolaget siktar på att ha fullrekryterat studien (ca 240 patienter) till Q4 2025 och presentera de första resultaten strax därefter:contentReference[oaicite:9]{index=9}. Efter tidigare blandade fas II-resultat i RA är detta data som kan bekräfta resomelagons effekt i rätt patientgrupp. Positiva resultat skulle återuppbygga förtroendet och kunna fördubbla kursen (samt underlätta partner/finansiering), medan ännu ett svagt utfall vore förödande. Med nuvarande nedpressat värde bedöms kursreaktionen vid framgång som stor.",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 80
    },
    {
        "stockName": "Dicot",
    ...
    },
    {
        ...
        "triggerDescription": "Terranet planerar att under Q3 2025 leverera en MVP (Minimum Viable Product) av sitt anti-kollisionssystem BlincVision till utvalda fordonstillverkare för utvärdering:contentReference[oaicite:12]{index=12}. Detta innebär att potentiella kunder själva kan testa systemet i praktiken. Under Q4 2025 finns förhoppningar om att dessa tester leder till konkreta samarbetsavtal eller order. Ett första kommersiellt avtal med en fordonstillverkare skulle vara ett stort genombrott för Terranet och förväntas ge en mycket stor positiv kurseffekt, givet bolagets låga värdering och avsaknad av tidigare större intäkter.",
        "triggerImpact": "jättehög",
        "triggerImpactPercentage": 100
    },
    {
        ...
        "date": "2025-12-31",
        "originalDate": "Q4?",
        "triggerDescription": "Möjligt genombrott inom 3D-printing för metall: Freemelt har sedan 2024 samarbetat med Saab kring additiv tillverkning av komponenter (t.ex. 3D-printade koppardetaljer för försvarsindustrin:contentReference[oaicite:13]{index=13}). Under Q4 2025 kan detta mynna ut i att Saab initierar serietillverkning med Freemelts EBM-skrivare eller lägger en större beställning om testerna fallit väl ut. Ett sådant besked skulle validera Freemelts teknik för industriell produktion och sannolikt driva betydande kursuppgång (potential för ~30–50% ökning) då det bekräftar intäktsmöjligheter i större skala.",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 50
    },
    {
        ...
        "triggerDescription": "Eventuellt större ordertillkännagivande för satellitbolaget AAC Clyde Space. Bolaget har indikerat god orderingång 2024–2025 men orderboken minskade under Q1 2025:contentReference[oaicite:14]{index=14}. I marknaden spekuleras det om AAC tävlar om en mycket stor konstellationsorder värd antingen ~200 MSEK eller uppemot ~700 MSEK. Ett offentliggörande av en order i den storleksordningen vore transformerande – t.ex. en 700 MSEK-order skulle mer än dubbla nuvarande orderstock och ge fleråriga intäkter. Effekten på aktien väntas bli kraftig positiv: för en mellanstor order (~200 MSEK) kanske måttligt hög, men för en riktigt stor (~700 MSEK) potentiellt mycket hög (kursen kan stiga avsevärt då framtida tillväxt säkras).",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 40
    },
    {
    ...
    },
    {
        ...
        "triggerDescription": "Planerad kommersiell lansering i USA av Cessatechs nasalsprejbaserade smärtlindring för barn (CT001). Bolaget fokuserar nu på att få ut produkten på USA-marknaden under 2025:contentReference[oaicite:24]{index=24}, efter att ha säkrat tillverkning och eventuella regulatoriska klartecken. Cessatech har redan tecknat ett partnerskap (Proveca) för Europa:contentReference[oaicite:25]{index=25}, men avser att själv (eller via ny partner) lansera i USA. Om försäljningsstart i USA faktiskt sker under H2 2025, innebär det att Cessatech går från utvecklingsbolag till intäktsgenerering. Det skulle vara en stor milstolpe och troligen höja aktien avsevärt – både pga framtida intäkter och ökad trovärdighet. Givet bolagets ringa värdering kan kursreaktionen vid en lyckad USA-launch vara hög (t.ex. 50%±).",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 50
    },
    {
        ...
        "triggerDescription": "Topplinjeresultat från Cereno Scientifics fas I-studie med läkemedelskandidaten CS014 (”Cerano”), en epigenetisk HDAC-hämmare med sjukdomsmodifierande potential vid bl.a. fibros i lungor och kärl. Fas I-studien avslutades i april 2025 och topplinedata väntas presenteras i juni 2025:contentReference[oaicite:26]{index=26}:contentReference[oaicite:27]{index=27}. Studien är huvudsakligen för säkerhet; ett positivt utfall (god tolerabilitet och gynnsam farmakodynamik) banar väg för fas II i t.ex. idiopatisk lungfibros. På marknaden spekuleras det i att Cereno kan ingå ett partneravtal/licensavtal för CS014 efter fas I, givet att bolaget historiskt använt partners för vidare utveckling. Analytiker väntar sig visserligen att licensaffärer sker när projekten nått fas II:contentReference[oaicite:28]{index=28}, men om fas I-data imponerar finns chans till tidigare intresse. Ett sådant avtal skulle vara ett stort värdedrivande event. Sammantaget bedöms triggern ha medelhög till hög kurspåverkan – ett fas I-resultat utan avvikelser ger begränsad kursuppgång i sig, men om det åtföljs av konkreta förhandlingar eller bud kan effekten bli större (en deal kan ge snabb premie på kursen).",
        "triggerImpact": "hög",
        "triggerImpactPercentage": 30
    },
    {
